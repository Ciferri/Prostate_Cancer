...
#define PAR_TIMER     m_param->at(2)
#define PAR_M         m_param->at(3)
#define PAR_K         m_param->at(4)
#define PAR_PO2       m_param->at(5)
#define PAR_ALPHA     m_param->at(6)
#define PAR_BETA      m_param->at(7)
